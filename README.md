...
| ---------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- |
| **Spots Classic (Project 6)** 🖼️         | Social media web app for adding, liking, and deleting posts                  | HTML, CSS, JS, CSS Grid, Figma                         | [View Live](https://velasqfr.github.io/se_project_spots_classic/)                                                          |
| **Spots JS (Project 9)** ⚡              | Enhanced Spots with modular JS, Webpack, dynamic behavior                    | HTML, CSS, JS (ES6 Modules), Webpack, Babel            | [View Live](https://velasqfr.github.io/se_project_spots/) or run locally: `npm install` → `npm run dev` → open `localhost` |
...
- Add authentication & backend storage to **Spots JS** ⚡ and **WTWR** 🌤️
